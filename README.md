...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/bitter-hill-820d
```

A live public deployment of this template is available at [https://bitter-hill-820d.templates.workers.dev](https://bitter-hill-820d.templates.workers.dev)
